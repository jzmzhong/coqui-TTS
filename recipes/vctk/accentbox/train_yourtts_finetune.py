...
RESTORE_PATH = "TO-CHANGE"  # "/root/.local/share/tts/tts_models--multilingual--multi-dataset--your_tts/model_file.pth"
...
VCTK_DOWNLOAD_PATH = "/home/s2526235/AccentedTTS/data/VCTK-Corpus-0.92-24kHz/"
...
vctk_config = BaseDatasetConfig(
    ...
    ignored_speakers=[
        "p261",
        "p228", # originally p225, southern england, English
        "p294",
        "p347",
        "p253",
        "p252", # originally p234, edinburgh, Scottish
        "p248",
        "p335",
        "p245",
        "p326",
...
# for dataset_conf in DATASETS_CONFIG_LIST:
#     # Check if the embeddings weren't already computed, if not compute it
#     embeddings_file = os.path.join(dataset_conf.path, "accents.pth")
