...
RUN_NAME = "YourTTS-Base-LibriTTSR"
...
LIBRITTSR_DOWNLOAD_PATH = "/home/s2526235/AccentedTTS/data/LibriTTS_R"

# init configs
libritts_train1_config = BaseDatasetConfig(
    formatter="libri_tts",
    dataset_name="libri_tts_r_1",
    meta_file_train="",
    meta_file_val="",
    path=os.path.join(LIBRITTSR_DOWNLOAD_PATH, "train-clean-360/"),
    language="en",
)

libritts_train2_config = BaseDatasetConfig(
    formatter="libri_tts",
    dataset_name="libri_tts_r_2",
    meta_file_train="",
    meta_file_val="",
    path=os.path.join(LIBRITTSR_DOWNLOAD_PATH, "train-clean-100/"),
    language="en",
)
...
DATASETS_CONFIG_LIST = [libritts_train1_config, libritts_train2_config]
...
SPEAKER_ENCODER_CHECKPOINT_PATH = ("/home/s2526235/AccentedTTS/models/speaker_encoder/model_se.pth.tar")

# SPEAKER_ENCODER_CONFIG_PATH = "https://github.com/coqui-ai/TTS/releases/download/speaker_encoder_model/config_se.json"
SPEAKER_ENCODER_CONFIG_PATH = "/home/s2526235/AccentedTTS/models/speaker_encoder/config_se.json"
...
config = VitsConfig(
    ...
    run_description="""
            - Original YourTTS trained using LibriTTS-R dataset
        """,
