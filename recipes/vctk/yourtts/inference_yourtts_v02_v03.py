...
MODEL2CKPTS = {
    # "02_acc-emb-January-13-2024_10+37PM-2016a95": [140000],
    "03_weighted-sampler-acc-January-13-2024_10+37PM-2016a95": [140000],
}
    ...
    for CKPT in CKPTS:
        for TXT, SPKS in TEST_TXT2SPK.items():
            ...
            for (SPK, ACC) in SPKS:
                ...
                OUTPUT_WAV_FOLDER = os.path.join(MODEL_DIR, "text_{}_speaker_{}_accent_{}_checkpoint_{}".format(TXT, SPK, ACC, CKPT))
